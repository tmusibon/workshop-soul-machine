        ...
        <div className="card col-lg-6 p-3 mb-2">
          <div className="card-body">
            <h2 className="header-with-bottom-border">
              <CheckSquare /> First things first
            </h2>
            ...
            <div className="mb-3">
              ...
              >
                <div className="modal-dialog modal-xl">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">{eula}</div>
                  </div>
                </div>
              </div>
              <div className="mx-4">
              ...
              <div className="mx-4">
                ...
                <CameraVideo /> My camera and microphone will be used
              </div>
              <div className="mx-4">
                <GraphUp /> Anonymized usage data will be captured
              </div>
            </div>

            <h4 className="header-with-bottom-border">What information are we collecting?</h4>
            <p>
              We will be collecting information about your facial features, expressions and voice
              characteristics when you are interacting with the Digital Human. If you want to find
              out more information and how we collect and use your information please see our
              ...
              <a
                ...
                rel="noreferrer"
              >
                https://www.soulmachines.com/privacy-policy/
              </a>
              .
            </p>
            <p>If you are happy to proceed on this basis, please confirm your acceptance.</p>
          </div>
          <Link
            to="loading"
            className="btn btn-success btn-lg action-btn"
            onClick={() => dispatchAcceptTOS(true)}
          >
            I accept Privacy Notice and EULA <ArrowRightCircleFill />
          </Link>
        </div>
      </div>
    </div>
